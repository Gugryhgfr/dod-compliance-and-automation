...
# Control: VCFN-9X-000076
# Title:   The VMware Cloud Foundation NSX Manager must be configured to protect against known types of denial-of-service (DoS
# Severity:medium  CCI:CCI-000054,CCI-002385  NIST:AC-10,SC-5 a
#
...
VCFN-9X-000076_api:
  cmd.run:
    - name: 'curl -ksS -X PUT ''https://localhost/api/v1/cluster/api-service'' -H ''Content-Type: application/json'' -d ''<<lookup(''template'', ''./nsx_manager_update_api_service_api_limits.json.j2'')>>'''
