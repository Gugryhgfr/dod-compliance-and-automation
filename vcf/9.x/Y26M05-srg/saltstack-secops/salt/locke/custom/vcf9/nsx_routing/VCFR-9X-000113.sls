...
VCFR-9X-000113_api:
  cmd.run:
    - name: 'curl -ksS -X PATCH ''https://localhost/policy/api/v1/infra/tier-1s/<<var_outer_t1.id>>'' -H ''Content-Type: application/json'' -d ''<<lookup(''template'', ''./nsx_routing_t1_disable_dhcp.json.j2'')>>'''
