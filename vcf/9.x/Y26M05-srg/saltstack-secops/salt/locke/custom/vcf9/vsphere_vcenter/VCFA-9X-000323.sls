...
VCFA-9X-000323:
  cmd.run:
    - name: 'pwsh -NoProfile -Command "Get-VDPortgroup | Where-Object {$_.ExtensionData.Config.BackingType -eq \"standard\" -and $_.IsUplink -eq $false} | Get-VDSecurityPolicy | Set-VDSecurityPolicy -ForgedTransmits $false"'
...
{% else %}
VCFA-9X-000323_manual:
  test.succeed_with_changes:
    - name: 'API control VCFA-9X-000323: enable pillar vcf_secops:enable_powercli or review manually.'
{% endif %}
