...
VCFJ-9X-000008_step4:
  file.append:
    - name: /etc/httpd/conf/httpd.conf
    - text: 'CustomLog "/common/logs/httpd/access.log" common'

VCFJ-9X-000008_step5:
  file.replace:
    - name: /etc/httpd/conf/httpd.conf
    - pattern: '(?!^#)(^\s*CustomLog\s*)(.*)(common)$'
    - repl: '\1"/common/logs/httpd/access.log" common'
    - append_if_not_found: True
    - backup: False
